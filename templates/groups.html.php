...
<div class="col-auto">
  ...
  <div class="<?= (isset($_SESSION['display_sort']['groups']) ? "show" : "collapse") ?>" id="colGroups">
    <div class="card card-body">
      ...
      <span title="<?= (!empty($desc) ? "$desc" : "")?>" class="mr-2"><?= $group ?><button type='submit' id='group_del' name='grpCmd' value='group_del|<?= $group ?>' class='btn btn-txt btn-outline-info color-custom align-text-bottom'><em class='fa-solid fa-circle-xmark pl-1'></em></button></span>
      <?php endforeach ?>
